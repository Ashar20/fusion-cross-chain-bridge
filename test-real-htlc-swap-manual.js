...
console.log('🧪 TESTING REAL HTLC SWAP (MANUAL ABI)')
...
// Manual ABI definition to avoid version issues
const manualAbi = {
...
async function testRealHTLCSwapManual() {
  try {
    ...
    try {
      ...
      // Step 3: Get HTLC details
      if (htlcId) {
        console.log('\n🔍 STEP 3: GETTING HTLC DETAILS')
        console.log('-' .repeat(30))
