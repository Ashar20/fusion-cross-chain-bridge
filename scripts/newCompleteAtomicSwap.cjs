...
/**
 * 🎯 NEW COMPLETE ATOMIC SWAP WITH CORRECT HASHING
 * 
 * Create a new ETH → ALGO atomic swap using keccak256 hashing
...
class NewCompleteAtomicSwap {
    constructor() {
        console.log('🎯 NEW COMPLETE ATOMIC SWAP WITH CORRECT HASHING');
        console.log('================================================');
        console.log('✅ Using keccak256 hashing (what the contract expects)');
        console.log('✅ Known secret for complete demonstration');
        console.log('✅ Full atomic swap with proof generation');
        console.log('================================================\n');
    ...
    async initialize() {
        ...
        // 🔐 CORRECT APPROACH: Generate secret and use keccak256 for hashlock
        ...
        this.swapParams.timelock = currentBlock.timestamp + 86400 + 7200; // 24 hours + 2 hours buffer
        
        console.log('🔒 SWAP PARAMETERS (CORRECT KECCAK256):');
    ...
    async step2_createEthereumOrder() {
        ...
        try {
            ...
            const tx = await this.resolver.createCrossChainHTLC(
                ...
                "NEW_TEST_ALGO_ADDRESS", // Use new test address
    ...
    async generateCompleteProof() {
        ...
        try {
            const proof = {
                testType: 'ETH_TO_ALGO_NEW_COMPLETE_ATOMIC_SWAP_PROOF',
            ...
            // Save proof to file
            const proofPath = 'ETH_TO_ALGO_NEW_COMPLETE_SWAP_PROOF.json';
    ...
    async runCompleteTest() {
        try {
            console.log('🚀 STARTING NEW COMPLETE ATOMIC SWAP');
            console.log('=====================================');
            console.log('');
            ...
            console.log('🎉 NEW ATOMIC SWAP COMPLETED!');
            console.log('==============================');
...
// Run the new complete atomic swap
async function main() {
    try {
        const test = new NewCompleteAtomicSwap();
