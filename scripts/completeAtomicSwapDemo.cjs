 ...
 * 
 * Demonstrate the full ETH → ALGO atomic swap process using correct keccak256 hashing
 * ✅ Step 1: Create Ethereum order with proper keccak256 hashlock
 * ✅ Step 2: Create Algorand HTLC with same hashlock
...
class CompleteAtomicSwapDemo {
    constructor() {
        ...
        console.log('✅ Complete proof generation');
        console.log('=====================================\n');
    ...
    async initialize() {
        ...
        this.swapParams.timelock = currentBlock.timestamp + (86400 * 7); // 7 days (like the working simple test)
    ...
    async step1_createEthereumOrder() {
        ...
        try {
            ...
            const tx = await this.resolver.createCrossChainHTLC(
                ...
                "DEMO_ALGO_ADDRESS", // Use demo address
    ...
    async generateCompleteProof() {
        ...
        try {
            const proof = {
                testType: 'ETH_TO_ALGO_COMPLETE_DEMO_PROOF',
            ...
            // Save proof to file
            const proofPath = 'ETH_TO_ALGO_COMPLETE_DEMO_PROOF.json';
    ...
    async runCompleteDemo() {
        try {
            console.log('🚀 STARTING COMPLETE ATOMIC SWAP DEMONSTRATION');
            console.log('==============================================');
            console.log('');
            ...
            console.log('🎉 COMPLETE ATOMIC SWAP DEMONSTRATION FINISHED!');
            console.log('================================================');
...
// Run the complete atomic swap demonstration
async function main() {
    try {
        const demo = new CompleteAtomicSwapDemo();
