...
/**
 * 🎯 Create HTLC Manual - Final Solution
 * 
 * This script provides the exact manual command to create an HTLC.
 */

const crypto = require('crypto');

class HTLCManualCreator {
    constructor() {
    ...
    async createHTLCManual() {
        console.log(`🎯 Create HTLC Manual - Final Solution`);
        console.log(`============================================================`);
...
async function main() {
    const creator = new HTLCManualCreator();
    await creator.createHTLCManual();
}
...
module.exports = { HTLCManualCreator }; 