...
/**
 * 🌉 WORKING ATOMIC SWAP: 0.005 ETH → ALGO 
 * 
 * Uses EXISTING contract (743645803) with CORRECT parameter handling
 * Fixed all parameter mismatches discovered during debugging
 */
...
class WorkingAtomicSwap005ETH {
    constructor() {
        console.log('🌉 WORKING ATOMIC SWAP: 0.005 ETH → ALGO');
        console.log('=========================================');
        ...
        console.log('✅ Fixed: Grouped payment transaction');
        console.log('=========================================\n');
    ...
    async initialize() {
        ...
        console.log('✅ Working Atomic Swap Initialized');
    ...
    async relayerCreateAlgoHTLCWorking(ethHTLC) {
        console.log('\n🤖 STEP 2: RELAYER CREATES ALGO HTLC (WORKING)');
        console.log('===============================================');
        console.log('✅ Using "create" function name (not create_htlc)');
        console.log('✅ Using 6 parameters (not 7)');
        console.log('✅ Grouped with payment transaction');
        console.log('🔄 Creating working HTLC on Algorand...');
        
        const suggestedParams = await this.algoClient.getTransactionParams().do();
        
        // CORRECT: Use "create" and 6 parameters (as contract expects)
        const algoHTLCTxn = algosdk.makeApplicationNoOpTxnFromObject({
            ...
            appArgs: [
                new Uint8Array(Buffer.from('create', 'utf8')), // CORRECT: "create" not "create_htlc"
                ...
                // REMOVED: eth_address (7th parameter) - contract only expects 6!
            ]
        });
    ...
    async userClaimALGOWorking(algoHTLC) {
        console.log('\n👤 STEP 3: USER CLAIMS ALGO (WORKING)');
        console.log('=====================================');
        console.log('✅ Using "withdraw" function name');
        console.log('✅ Using 2 parameters (htlc_id, secret)');
        console.log('🔑 User revealing secret to claim 0.5 ALGO...');
        
        const suggestedParams = await this.algoClient.getTransactionParams().do();
        
        // CORRECT: Use "withdraw" with 2 parameters
        ...
        console.log('✅ User claim transaction confirmed!');
    ...
    async executeCompleteSwap() {
        try {
            console.log('🚀 STARTING WORKING 0.005 ETH → ALGO ATOMIC SWAP');
            console.log('==================================================\n');
            ...
            const algoHTLC = await this.relayerCreateAlgoHTLCWorking(ethHTLC);
            const algoClaim = await this.userClaimALGOWorking(algoHTLC);
            ...
            if (balanceSuccess) {
                ...
                console.log('✅ 0.5 ALGO HTLC created and funded properly');
                ...
                console.log('✅ ALGO HTLC created');
                console.log('❌ User did not receive ALGO (contract issue)');
                
                return {
                    success: false,
                    partialSuccess: true,
                    issue: 'ALGO not transferred to user',
                    transactions: {
                        ethHTLC: ethHTLC,
                        algoHTLC: algoHTLC,
                        algoClaim: algoClaim
...
// Execute the WORKING 0.005 ETH atomic swap
async function main() {
    const atomicSwap = new WorkingAtomicSwap005ETH();
    const result = await atomicSwap.executeCompleteSwap();
    
    if (result.success) {
        console.log('\n🌟 SWAP SUMMARY (WORKING VERSION)');
        console.log('=================================');
        ...
        console.log('\n✅ Working atomic swap with proper parameter handling!');
    }
...
module.exports = WorkingAtomicSwap005ETH; 
