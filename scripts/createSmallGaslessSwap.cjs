...
/**
 * 🚀 SMALL GASLESS ALGO TO ETH SWAP
 * 
 * Performs a smaller gasless cross-chain swap that works with available balance
 */
...
class SmallGaslessSwap {
    constructor() {
        console.log('🚀 SMALL GASLESS ALGO TO ETH SWAP');
        console.log('==================================');
        console.log('✅ Smaller amount to work with available balance');
    ...
    async initialize() {
        ...
        // Smaller swap parameters - works with available balance
        this.swapParams = {
            ethAmount: ethers.parseEther('0.0001'), // 0.0001 ETH (smaller amount)
            algoAmount: 100000, // 0.1 ALGO (100,000 microALGO)
        ...
        console.log('✅ Small Gasless Swap Initialized');
        ...
        console.log(`💰 Swap Amount: 0.1 ALGO → 0.0001 ETH`);
    ...
    async relayerCreateAlgorandHTLC() {
        console.log('🚀 RELAYER CREATING ALGORAND HTLC (SMALL AMOUNT)');
        console.log('===============================================');
        console.log('🔄 Relayer creating Algorand HTLC with 0.1 ALGO...');
        ...
        try {
            ...
            const algoHTLCTxn = algosdk.makeApplicationNoOpTxnFromObject({
                ...
                appArgs: [
                    ...
                    algosdk.encodeUint64(this.swapParams.algoAmount), // amount (0.1 ALGO)
    ...
    async relayerCreateEthereumHTLC() {
        console.log('🏗️ RELAYER CREATING ETHEREUM HTLC (SMALL AMOUNT)');
        console.log('===============================================');
    ...
    async relayerClaimAlgoForUser() {
        console.log('🎯 RELAYER CLAIMING ALGO FOR USER (SMALL AMOUNT)');
        console.log('===============================================');
        ...
        try {
            ...
            console.log('💰 User received 0.1 ALGO without paying fees!');
    ...
    async runSmallSwap() {
        try {
            console.log('🚀 STARTING SMALL GASLESS ALGO TO ETH SWAP');
            console.log('==========================================\n');
            ...
            console.log('📊 STEP 2: RELAYER CREATING ALGORAND HTLC (SMALL AMOUNT)');
            console.log('=======================================================');
            await this.relayerCreateAlgorandHTLC();
            
            // Step 3: Relayer creates Ethereum HTLC (Relayer pays ETH gas)
            console.log('📊 STEP 3: RELAYER CREATING ETHEREUM HTLC (SMALL AMOUNT)');
            console.log('=======================================================');
            await this.relayerCreateEthereumHTLC();
            
            // Step 4: Relayer claims ALGO for user (Gasless)
            console.log('📊 STEP 4: RELAYER CLAIMING ALGO FOR USER (SMALL AMOUNT)');
            console.log('=======================================================');
            ...
            console.log('🎉 SMALL ALGO TO ETH SWAP COMPLETED!');
            console.log('====================================');
            console.log('✅ User received 0.1 ALGO');
    ...
    async generateSwapReport(initialBalances, finalBalances) {
        const report = {
            ...
            swapType: 'SMALL_ALGO_TO_ETH_RELAYER_GASLESS',
            swapParams: {
        ...
        fs.writeFileSync('SMALL_GASLESS_ALGO_TO_ETH_REPORT.json', JSON.stringify(report, null, 2));
        ...
        console.log('✅ Small amount swap (0.1 ALGO)');
        console.log(`📊 Report saved to: SMALL_GASLESS_ALGO_TO_ETH_REPORT.json\n`);
    }
}

// Execute the small gasless swap
async function main() {
    const swap = new SmallGaslessSwap();
    const result = await swap.runSmallSwap();
    ...
    if (result.success) {
        ...
        console.log('✅ User received 0.1 ALGO');
        console.log('✅ Completely gasless experience');
        console.log('\n🎉 Small swap demonstration completed!');
    }
...
module.exports = SmallGaslessSwap; 