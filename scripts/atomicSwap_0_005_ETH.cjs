...
/**
 * 🌉 ATOMIC SWAP: 0.005 ETH → ALGO (ROUND 2)
 * 
 * Using the FIXED Enhanced1inchStyleBridge with complete bidding mechanism
 * Amount: 0.005 ETH → 0.5 ALGO (10x larger than previous swap)
 */
...
class AtomicSwap005ETH {
    constructor() {
        console.log('🌉 ATOMIC SWAP: 0.005 ETH → ALGO (ROUND 2)');
        console.log('============================================');
        console.log('✅ 10x Larger Swap Amount');
    ...
    async initialize() {
        ...
        console.log('✅ Atomic Swap Round 2 Initialized');
    ...
    async executeCompleteSwap() {
        try {
            console.log('🚀 STARTING 0.005 ETH → ALGO ATOMIC SWAP');
            console.log('========================================\n');
            ...
            console.log('✅ 0.5 ALGO HTLC created by relayer');
            console.log('✅ User claimed 0.5 ALGO');
...
async function main() {
    ...
    if (result.success) {
        ...
        console.log('\n✅ Atomic swap infrastructure proven with larger amounts!');
    }
