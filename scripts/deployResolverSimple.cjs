...
async function main() {
    console.log('🚀 Deploying CrossChainHTLCResolver (Simplified)...');
    console.log('==================================================');
    ...
    // Compile only the CrossChainHTLCResolver
    console.log('\n📦 Compiling CrossChainHTLCResolver...');
    
    // Create a simple contract factory for CrossChainHTLCResolver
    const CrossChainHTLCResolver = await ethers.getContractFactory('CrossChainHTLCResolver');
    
    console.log('✅ CrossChainHTLCResolver compiled successfully');
